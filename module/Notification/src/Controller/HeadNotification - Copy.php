...
class HeadNotification
{
    ...
    private static function sendPayslipEmail(PaySlipDetailsModel $payslipDetail, AdapterInterface $adapter, Url $url)
    {
        ...
        <table class="table table-bordered" style="width: 100%; border-collapse: collapse;border:1px solid #dddddd;">
                ...
                <tr>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Present Days </td>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">' . $payslipDetail->setProperty1['USE_PRESENT'] . '</td>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Absent Days </td>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">' . $payslipDetail->setProperty1['USE_ABSENT'] . '</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Salary </td>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">' . $payslipDetail->setProperty1['MONTHLY_SALARY'] . '</td>
                ...
                <tr>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Monthly Allowance </td>
                    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">' . $payslipDetail->setProperty1['ALLOWANCE'] . '</td>
