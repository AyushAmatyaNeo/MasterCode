...
class LeaveApproveRepository implements RepositoryInterface
{
  ...
  public function getAllRequest($id)
  {
    $sql = "SELECT 
                  ...
                  (CASE WHEN (LA.HALF_DAY IS NULL OR  LA.HALF_DAY = 'N')THEN LA.NO_OF_DAYS else la.NO_OF_DAYS/2 end) as no_of_days,                  INITCAP(TO_CHAR(LA.REQUESTED_DT, 'DD-MON-YYYY')) AS APPLIED_DATE_AD,
                ...
                LEFT JOIN HRIS_EMPLOYEES E3 
                ON E3.EMPLOYEE_ID = RA.RECOMMEND_BY
                LEFT JOIN HRIS_EMPLOYEES E4 
                ON E4.EMPLOYEE_ID = RA.APPROVED_BY
